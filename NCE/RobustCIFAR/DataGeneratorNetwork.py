...
class DataGeneratorNetwork(object):
    ...
    def build_model(self):
        ...
        with self.g.as_default():
            ...
            self.loss = custom_loss(original_images= self.X, generated_images= generated_images, target_batch=  self.Y)
    ...
    def train(self):
        ...
        for epoch in range(num_epochs):
            ...
            for I in range(num_iter):
                ...
                x_t, y_t = x_test[random_test_inds], y_test[random_test_inds]

                feed_train = {self.X: x, self.Y: y, self.is_train: True}
                feed_test = {self.X: x_t, self.Y: y_t, self.is_train: True}
