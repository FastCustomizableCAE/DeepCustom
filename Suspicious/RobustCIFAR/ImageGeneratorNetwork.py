...
class ImageGeneratorNetwork(object):
    ...
    def build_model(self):
        ...
        with self.g.as_default():
            ...
            # Decoding
            out4 = deconv_layer(input=encoded, filter_size=128, stride=3, kernel=2, batch_norm=True,
            ...
            self.loss = custom_loss(original_image=self.X, generated_image=generated_images)
